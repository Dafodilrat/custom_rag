...
class VectorDBManager:
    ...
    def retrieve_context(self, query: str, n_results: int = 5) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for doc, path in zip(results["documents"][0], results["metadatas"][0]):
    ...
    def get_augmented_query(self, user_query: str) -> str:
        ...
        context_str,paths = self.retrieve_context(user_query, n_results=4)
        ...
        {context_str}
        --- END CONTEXT ---
        The files have been fetched from the following sources.Mention this while answering the query.
